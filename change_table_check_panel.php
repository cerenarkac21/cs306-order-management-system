...
<h1></h1>
<center>
<a href="update_check_panel.php?id=<?php echo $check_id ?>"
<div class="text-center">
	<input name="aghh" class="btn btn-success" value="Add Food">
	</div>
</div>
    </a>
    </center>
    ...
    <h1></h1>
<center>
<a href="select_table_check.php"
<div class="text-center">
	<input name="aghh" class="btn btn-success" value="RETURN MAIN MENU">
	</div>
</div>
    </a>
    </center>
